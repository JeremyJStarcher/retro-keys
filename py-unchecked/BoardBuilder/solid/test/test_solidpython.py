...
scad_test_case_templates = [
    {
        "name": "polygon",
        "kwargs": {"paths": [[0, 1, 2]]},
        "expected": "\n\npolygon(paths = [[0, 1, 2]], points = [[0, 0, 0], [1, 0, 0], [0, 1, 0]]);",
...
class TestSolidPython(DiffOutput):
    ...
    def test_parse_scad_callables(self):
        ...
        expected = [
            ...
            {"args": [], "name": "righty", "kwargs": ["angle"]},
            {"args": ["avar"], "name": "lefty", "kwargs": []},
            {"args": [], "name": "more", "kwargs": ["a"]},
            {
                "args": [],
                "name": "pyramid",
                "kwargs": [
            ...
            {"args": [], "name": "float_arg", "kwargs": ["arg"]},
        ]
