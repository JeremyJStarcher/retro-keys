...
class circle(OpenSCADObject):
    ...
    def __init__(self, r=None, d=None, segments=None):
        OpenSCADObject.__init__(self, "circle", {"r": r, "d": d, "segments": segments})
...
class square(OpenSCADObject):
    ...
    def __init__(self, size=None, center=None):
        OpenSCADObject.__init__(self, "square", {"size": size, "center": center})
...
class sphere(OpenSCADObject):
    ...
    def __init__(self, r=None, d=None, segments=None):
        OpenSCADObject.__init__(self, "sphere", {"r": r, "d": d, "segments": segments})
...
class cube(OpenSCADObject):
    ...
    def __init__(self, size=None, center=None):
        OpenSCADObject.__init__(self, "cube", {"size": size, "center": center})
...
class rotate_extrude(OpenSCADObject):
    ...
    def __init__(self, convexity=None, segments=None):
        OpenSCADObject.__init__(
            self, "rotate_extrude", {"convexity": convexity, "segments": segments}
        )
...
class surface(OpenSCADObject):
    ...
    def __init__(self, file, center=None, convexity=None, invert=None):
        OpenSCADObject.__init__(
            self,
            "surface",
            {"file": file, "center": center, "convexity": convexity, "invert": invert},
        )
...
class child(OpenSCADObject):
    def __init__(self, index=None, vector=None, range=None):
        OpenSCADObject.__init__(
            self, "child", {"index": index, "vector": vector, "range": range}
        )
...
class children(OpenSCADObject):
    ...
    def __init__(self, index=None, vector=None, range=None):
        OpenSCADObject.__init__(
            self, "children", {"index": index, "vector": vector, "range": range}
        )
...
class import_stl(OpenSCADObject):
    def __init__(self, file, origin=(0, 0), layer=None):
        OpenSCADObject.__init__(
            self, "import", {"file": file, "origin": origin, "layer": layer}
        )
...
def use(scad_file_path, use_not_include=True):
    ...
    try:
        ...
        raise Exception(
            "Failed to import SCAD module '%(scad_file_path)s' "
            "with error: %(e)s " % vars()
        )
    ...
    for sd in symbols_dicts:
        class_str = new_openscad_class_str(
            sd["name"], sd["args"], sd["kwargs"], scad_file_path, use_not_include
        )
